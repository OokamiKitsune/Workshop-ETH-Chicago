...
// Create a new file in the same directory where this file is "pages/quests/developers" and name your new file developer<YourName>.ts
// Replace <YourName> with your name. For example, if your name is Gandalf, then the file name would be developerGandalf.ts 🧙🏻‍♂️
